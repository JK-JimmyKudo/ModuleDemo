...
@property (nonatomic, readonly) NSString *jk_shortString; ///2024/11/29 12:02
@property (nonatomic, readonly) NSString *jk_shortDateString; ///2024/11/29
@property (nonatomic, readonly) NSString *jk_shortTimeString;///12:02
@property (nonatomic, readonly) NSString *jk_mediumString;///2024年11月29日 12:02:12
@property (nonatomic, readonly) NSString *jk_mediumDateString;///2024年11月29日
@property (nonatomic, readonly) NSString *jk_mediumTimeString;///12:02:12
@property (nonatomic, readonly) NSString *jk_longString;///2024年11月29日 GMT+8 12:02:12
@property (nonatomic, readonly) NSString *jk_longDateString;///2024年11月29日
@property (nonatomic, readonly) NSString *jk_longTimeString;///GMT+8 12:02:12
