...
+(instancetype)qmui_initWithFontSize:(CGFloat)fontSize TextColor:(UIColor*)color{
    
    return [self kj_createLabelWithText:@"" FontSize:fontSize TextColor:color Alignment:(NSTextAlignmentCenter)];;
}
@end
